...
import 'package:laundryapp/config/app_formart.dart';
import 'package:laundryapp/config/failure.dart';
import 'package:laundryapp/datasources/promo_datasource.dart';
import 'package:laundryapp/datasources/shop_datasource.dart';
import 'package:laundryapp/models/shop_model.dart';
import 'package:laundryapp/widgets/error_background.dart';
        ...
        (failure) {
          switch (failure.runtimeType) {
            ...
            case ForbiddenFailure:
              setHomePromoStatus(ref, 'You don\'t have access to this page');
              break;
        ...
        (failure) {
          switch (failure.runtimeType) {
            ...
            case NotFoundFailure:
              ...
              break;
            case ForbiddenFailure:
              setHomeRecommendationStatus(
                  ref, 'You don\'t have access to this page');
              break;
            case BadRequestFailure:
